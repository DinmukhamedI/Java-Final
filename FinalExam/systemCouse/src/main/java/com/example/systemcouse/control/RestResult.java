...
public class RestResult {
    ...
    @PUT
    @Path("/updateRank/{rankId}")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @RolesAllowed({"ADMIN"})
    public Response updateRank(
            @PathParam("rankId") long id,
    ...
    @DELETE
    @Path("/deleteRank/{rankId}")
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({"ADMIN","INSTRUCTOR"})
    public Response deleteRank(
            @PathParam("rankId") int id) {
    ...
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @RolesAllowed("ADMIN")
    public Response updateTutor(
            @PathParam("tutorId") long id,
    ...
    @DELETE
    @Path("/deleteTutor/{tutorId}")
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed("ADMIN")
    public Response deleteAgent(
            @PathParam("tutorId") int id) {
