...
public class UserRepository {
    ...
    private static final String INSERT_BASE_SQL = "insert into user_" +
            " (user_id, user_name, last_session, rank.rank_id) VALUES (?, ?, ?, ?);";
    private static final String SELECT_ALL_BASE = "select * from user_";
    private static final String SELECT_BASE_BY_ID =
            "select user_name,  last_session, rank.rank_id, rank_name FROM user_, rank where user_.rank_id = rank.rank_id and user_id = ?;";
    private static final String DELETE_BASE_SQL = "delete from user_ where user_id = ?;";
    private static final String UPDATE_BASE_SQL = "update user_ set user_name=?, last_session=?, rank_id = ? where user_id = ?;";
