...
import com.example.systemcouse.model.User_;
...
public class TutorRepository {
    private static final String jdbcURL  = "jdbc:h2:~/CourseManagement";
    ...
    private static final String SELECT_BASE_BY_ID = "select tutor_name, description, specialization FROM tutor where tutor_id = ?;";
    private static final String DELETE_BASE_SQL = "delete from tutor where tutor_id = ?;";
    private static final String UPDATE_BASE_SQL = "update tutor set tutor_name=?, description=?, specialization=? where tutor_id = ?;";
    ...
    public Tutor selectTutor(int tutorId) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                String specialization = rs.getString("specialization");
                String description = rs.getString("description");
                tutor = new Tutor((long) tutorId, tutorName, specialization, description);
            }
